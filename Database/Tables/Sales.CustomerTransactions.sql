...
GO
ALTER TABLE [Sales].[CustomerTransactions] ADD CONSTRAINT [PK_Sales_CustomerTransactions] PRIMARY KEY NONCLUSTERED  ([CustomerTransactionID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_CustomerID] ON [Sales].[CustomerTransactions] ([CustomerID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_InvoiceID] ON [Sales].[CustomerTransactions] ([InvoiceID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [IX_Sales_CustomerTransactions_IsFinalized] ON [Sales].[CustomerTransactions] ([IsFinalized]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_PaymentMethodID] ON [Sales].[CustomerTransactions] ([PaymentMethodID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE CLUSTERED INDEX [CX_Sales_CustomerTransactions] ON [Sales].[CustomerTransactions] ([TransactionDate]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_TransactionTypeID] ON [Sales].[CustomerTransactions] ([TransactionTypeID]) ON [PS_TransactionDate] ([TransactionDate])
GO
