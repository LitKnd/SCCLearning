...
GO
ALTER TABLE [Sales].[InvoiceLines] ADD CONSTRAINT [PK_Sales_InvoiceLines] PRIMARY KEY CLUSTERED  ([InvoiceLineID]) ON [USERDATA]
GO
CREATE NONCLUSTERED COLUMNSTORE INDEX [NCCX_Sales_InvoiceLines] ON [Sales].[InvoiceLines] ([InvoiceID], [StockItemID], [Quantity], [UnitPrice], [LineProfit], [LastEditedWhen]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_InvoiceLines_InvoiceID] ON [Sales].[InvoiceLines] ([InvoiceID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_InvoiceLines_PackageTypeID] ON [Sales].[InvoiceLines] ([PackageTypeID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_InvoiceLines_StockItemID] ON [Sales].[InvoiceLines] ([StockItemID]) ON [USERDATA]
GO
