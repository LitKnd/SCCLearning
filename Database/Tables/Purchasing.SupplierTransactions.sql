...
GO
ALTER TABLE [Purchasing].[SupplierTransactions] ADD CONSTRAINT [PK_Purchasing_SupplierTransactions] PRIMARY KEY NONCLUSTERED  ([SupplierTransactionID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [IX_Purchasing_SupplierTransactions_IsFinalized] ON [Purchasing].[SupplierTransactions] ([IsFinalized]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_SupplierTransactions_PaymentMethodID] ON [Purchasing].[SupplierTransactions] ([PaymentMethodID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_SupplierTransactions_PurchaseOrderID] ON [Purchasing].[SupplierTransactions] ([PurchaseOrderID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_SupplierTransactions_SupplierID] ON [Purchasing].[SupplierTransactions] ([SupplierID]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE CLUSTERED INDEX [CX_Purchasing_SupplierTransactions] ON [Purchasing].[SupplierTransactions] ([TransactionDate]) ON [PS_TransactionDate] ([TransactionDate])
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_SupplierTransactions_TransactionTypeID] ON [Purchasing].[SupplierTransactions] ([TransactionTypeID]) ON [PS_TransactionDate] ([TransactionDate])
GO
