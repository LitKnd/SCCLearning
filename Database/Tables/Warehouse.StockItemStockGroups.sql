...
GO
ALTER TABLE [Warehouse].[StockItemStockGroups] ADD CONSTRAINT [PK_Warehouse_StockItemStockGroups] PRIMARY KEY CLUSTERED  ([StockItemStockGroupID]) ON [USERDATA]
GO
ALTER TABLE [Warehouse].[StockItemStockGroups] ADD CONSTRAINT [UQ_StockItemStockGroups_StockGroupID_Lookup] UNIQUE NONCLUSTERED  ([StockGroupID], [StockItemID]) ON [USERDATA]
GO
ALTER TABLE [Warehouse].[StockItemStockGroups] ADD CONSTRAINT [UQ_StockItemStockGroups_StockItemID_Lookup] UNIQUE NONCLUSTERED  ([StockItemID], [StockGroupID]) ON [USERDATA]
GO
